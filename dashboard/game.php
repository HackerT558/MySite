...
<body>
    ...
    <div class="game-wrap">
        ...
        <div class="game-info">
            ...
            <div class="timer-display" id="timerDisplay">Выживание <span>1</span></div>
        ...
        <div class="game-instructions">
            ...
            <ul>
                ...
                <li><strong>Выживание:</strong> Каждые 60 секунд уровень выживания растет и игра становится сложнее</li>
